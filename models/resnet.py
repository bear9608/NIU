...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, zero_init_residual=False,
                 ...
                 norm_layer=None,scale_factor = 1.0):
        ...
        self.branch = self.branch = nn.ModuleList([self._make_branch(inplanes) for inplanes in
                                                   [64 * block.expansion, 128 * block.expansion,
                                                    256 * block.expansion]])
